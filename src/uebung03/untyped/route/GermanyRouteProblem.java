...
public class GermanyRouteProblem implements Problem {
    protected static final Map<String, Map<String, Integer>> cityDistances = Map.ofEntries(
            Map.entry("Aachen", Map.ofEntries(Map.entry("Essen", 123), Map.entry("Koblenz", 145), Map.entry("Köln", 72))),
            ...
            Map.entry("Köln", Map.ofEntries(Map.entry("Aachen", 72), Map.entry("Essen", 75), Map.entry("Koblenz", 110), Map.entry("Münster", 144))),
